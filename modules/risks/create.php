...
<div class="flex-1 flex flex-col min-w-0 overflow-hidden">
    ...
    <main class="flex-1 overflow-y-auto p-6 bg-[#FFFAF3]">
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div>
                <h2 class="text-2xl font-bold text-[#232426]">Create Enterprise Risk</h2>
                <p class="text-[#232426]/70 mt-1">Identify and log a new risk into the register.</p>
            </div>
            ...
            <!-- Risk Form Component -->
            <?php 
                $riskData = []; // empty data for create
                $isEdit = false;
