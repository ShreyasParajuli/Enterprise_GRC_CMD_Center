...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name)) {
        ...
        try {
            ...
            logActivity($pdo, $_SESSION['user_id'], "Created department: $name");
            
            $_SESSION["success_msg"] = "Created successfully."; header("Location: " . BASE_URL . "/pages/departments/index.php"); exit;
    ...
    <main class="flex-1 overflow-y-auto p-6">
        <div class="max-w-3xl mx-auto space-y-6">
            ...
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-2xl font-bold text-brand-dark">Create New Department</h2>
                    <p class="text-brand-dark/70 mt-1">Add a new organizational unit.</p>
                </div>
